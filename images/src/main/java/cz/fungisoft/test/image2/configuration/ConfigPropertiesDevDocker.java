...
/**
 * Obsahuje dalsi specificke konfiguracni parametry aplikace, ktere lze nacist z src/main/resources/configprops-dev_docker.properties souboru
 * <p>
...
@Configuration
@Profile("dev_docker")
@PropertySource({"classpath:configprops-dev_docker.properties"})
public class ConfigPropertiesDevDocker extends ConfigProperties
{}
