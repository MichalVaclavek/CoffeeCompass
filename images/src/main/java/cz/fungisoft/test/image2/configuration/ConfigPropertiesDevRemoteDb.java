...
/**
 * Obsahuje dalsi specificke konfiguracni parametry aplikace, ktere lze nacist z src/main/resources/configprops-dev_remote_db.properties souboru
 * <p>
 ...
 */
@Configuration
@Profile("dev_remote_db")
@PropertySource({"classpath:configprops-dev_remote_db.properties"})
public class ConfigPropertiesDevRemoteDb extends ConfigProperties
{}
