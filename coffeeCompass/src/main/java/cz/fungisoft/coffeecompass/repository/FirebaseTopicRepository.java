...
public interface FirebaseTopicRepository extends JpaRepository<FirebaseTopic, Integer> {
    ...
    List<FirebaseTopic> getAllFirebaseTopics();
    ...
    Optional<FirebaseTopic> getOneTopicSubtopic(String topic, String subTopic);
    ...
    void deleteTopic(String topic, String subTopic);
}
