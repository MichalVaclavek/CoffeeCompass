...
/**
 * Obsahuje konfiguracni parametry pro OAuth2 autentikaci, ktere se nacitaji z application-prod_docker.properties souboru<br>
...
@Configuration
@Profile("prod")
@PropertySource("classpath:application-prod_docker.properties")
